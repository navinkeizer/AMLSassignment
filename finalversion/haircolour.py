...
def get_images():
    ...
    for i in range(1, 5001):
        ...
        picDat[i - 1] = x
        # For using decision tree etc algorithms, include this line to reshape data. not necessary for CNN
...
def train_decision_tree(training_images, training_labels, test_images, test_labels):
    ...
    print(classification_report(np.argmax(np.round(test_labels), axis=1), predicted_classes))
...
def main():
    ...
    inspect(a,b,c,d,e,f)
    # print(contruct_cnn(7,a,b,c,d,e,f))
    # print(get_statistacs("cnnmodel1.h5py",a,b,c,d,e,f,7))
